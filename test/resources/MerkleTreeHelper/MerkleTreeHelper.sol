...
contract MerkleTreeHelper is CommonBase, ChainValues {
    ...
    /// @notice Adds leafs for HypoVaultManagerWithMerkleVerification fulfillDeposits and fulfillWithdrawals
    /// @param leafs The array to add leafs to
    /// @param manager The address of the HypoVaultManagerWithMerkleVerification contract
    function _addHypoVaultManagerLeafs(ManageLeaf[] memory leafs, address manager) internal {
        // fulfillDeposits
        unchecked {
            leafIndex++;
        }
