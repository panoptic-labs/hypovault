...
contract DeployHypoVaultArchitectureSepolia is BatchScript, MerkleTreeHelper {
    ...
    // CREATE2
    bytes32 salt = keccak256(abi.encodePacked("nov-25-804-a"));
    ...
    function run(bool send_) public isBatch(address(PanopticMultisig)) {
        ...
        address hypoVaultImplAddress = Create2.computeAddress(
            ...
            address(createCall) // ✅ Correct for CALL
        );
        ...
        addToBatch(createCall, 0, createFactoryCalldata, BatchScript.Operation.CALL);
        ...
        **********/
        ...
        bytes memory accountantConstructorArgs = abi.encode(PanopticMultisig);
        bytes memory accountantDeploymentData = abi.encodePacked(
            type(PanopticVaultAccountant).creationCode,
            accountantConstructorArgs
        );
        ...
        addToBatch(
            ...
            BatchScript.Operation.CALL // operation: 1 = DelegateCall (CRITICAL!)
        );
        ...
        **********/
        ...
        console.log("predicted wethPlpVaultAddress: ", wethPlpVaultAddress);

        bytes memory setFeeWalletCalldata = abi.encodeWithSelector(
            wethPlpVault.setFeeWallet.selector,
            TurnkeyAccount0 // TODO: confirm fee wallet
        );
        ...
        **********/
        ...
        bytes memory managerDeployCalldata = abi.encodePacked(
            ...
            abi.encode(address(PanopticMultisig), address(wethPlpVault), address(BalancerVaultAddr))
        );
        ...
        addToBatch(createCall, 0, createManagerCalldata, BatchScript.Operation.CALL);
        ...
        addToBatch(createCall, 0, createAuthorityCalldata, BatchScript.Operation.CALL);
